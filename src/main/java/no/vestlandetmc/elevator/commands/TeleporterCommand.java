...
import no.vestlandetmc.elevator.commands.subcommands.*;
import org.jspecify.annotations.NonNull;

import java.util.*;

public class TeleporterCommand implements BasicCommand {

	private final Map<String, SubCommand> subcommands = new HashMap<>();

	public TeleporterCommand() {
		register(new TeleporterAdd());
		register(new TeleporterHelp());
		register(new TeleporterLink());
		register(new TeleporterList());
		register(new TeleporterRemove());
		register(new TeleporterUnlink());
	}
